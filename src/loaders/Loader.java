...
public class Loader {
    ...
    public void addInstancedAttribute(int vao, int vbo, int attribute, int dataSize, int instancedDataLength, int offset){
        ...
        GL20.glVertexAttribPointer(attribute, dataSize, GL11.GL_FLOAT, false, (int) (instancedDataLength * 4L), offset * 4L);
    ...
    public int loadCubeMap(String[] texturesFiles){
        ...
        for (int i = 0; i < texturesFiles.length; i++){
            TextureData data = decodeTextureFile("res/textures/skybox/" + texturesFiles[i] + ".png");
    ...
    private TextureData decodeTextureFile(String file){
        ...
        try {
            ...
            e.printStackTrace();
            System.err.println("Tried to load texture " + file + ", but can't.");
            System.exit(-1);
        }
